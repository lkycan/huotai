...
window.onload = function () {
    ...
    util.init(function () {
        ...
        //                    server.workTag_list(function(e) {
        //                        jinengObj = e.list;
        //                        selectJineng = 0;
        //                        //                        showJinengList();
        //
        //                        $("#bindidlist2_1").bind("click", function() {
        //                            showFunlist2();
        //                        });
        //                        $("#bindidlist2_2").bind("click", function() {
        //                            showFunlist2();
        //                        });
        //                        console.log(e);
        //                    });
        //                    //绑定事件
        //                    initbind(document.getElementById("imgfile1"), document.getElementById("imgfile1img"), 0, "shenfen1");
        //                    initbind(document.getElementById("imgfile2"), document.getElementById("imgfile2img"), 0, "shenfen2");
        //                    initbind(document.getElementById("imgfile3"), document.getElementById("imgfile3img"), 1);
        //                    initbind(document.getElementById("imgfile4"), document.getElementById("imgfile4img"), 2);
        //                    initbind(document.getElementById("imgfile5"), document.getElementById("imgfile5img"), 3);
        //                    initbind(document.getElementById("imgfile6"), document.getElementById("imgfile6img"), 4);
        //                    initbind(document.getElementById("imgfile7"), document.getElementById("imgfile7img"), 5);
        //                    initbind(document.getElementById("imgfile9"), document.getElementById("imgfile9img"), 6);
        //                    initbind(document.getElementById("imgfile8"), "imgfile8", 0);
        //                    //                    gzzmObj();
        //                    yichuzm();
        ...
        //点击确定
        $$_bind("#layer1_2_4_1", "click", function () {
            console.log("点击确定");
            var acc = $$("#layer1_2_2_val").value;
            var pwd = $$("#layer1_2_3_val").value;
            if (acc != "" && pwd != "") {
                server.login(acc, pwd, function (data) {
                    ...
                    if (data.status == "success") {
                        ...
                        pageObj._acc = acc;
                        pageObj._code = pwd;
                        // ---admin:超级管理员   subadmin:二级管理员   user:用户
                        if (GameObj.login.user_info.level == "admin") {
                            //炒鸡管理员
                            $$("#user_item_1").style.display = "block";
                            $$("#user_item_4").style.display = "block";
                            $$("#user_item_5").style.display = "block";
                            openType(1);
                        } else {
                            $$("#user_item_1").style.display = "none";
                            $$("#user_item_4").style.display = "none";
                            $$("#user_item_5").style.display = "none";
                            openType(2);
                        }
                    }
        ...
        //点击取消
        $$_bind("#layer1_2_4_2", "click", function () {
            console.log("点击取消");
        });
